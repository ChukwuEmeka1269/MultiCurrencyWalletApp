...
//    public ResponseEntity<ExceptionResponse<?>> handleAuthenticationTokenException(AuthenticationTokenException ex, WebRequest request) {
//
...
//    public ResponseEntity<ExceptionResponse<?>> handleAuthExceptions(AuthException ex, WebRequest request) {
//
//        return getExceptionResponseResponseEntity(ex, HttpStatus.FORBIDDEN);
//    }
//
